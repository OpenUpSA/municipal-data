...
class ScorecardTest(BaseSeleniumTestCase):
    ...
    def test_data_explorer_links(self):
        ...
        self.assertIn('http://portal:8002/table/cflow_v2/?municipalities=BUF&year=2019&items=0430&amountType=AUDA', element[0].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#cash-balance ' + pre_class)
        self.assertIn('http://portal:8002/table/cflow/?municipalities=BUF&year=2019&items=4200&amountType=AUDA', element[0].get_attribute("href"))

        # Cash Coverage
        element = selenium.find_elements_by_css_selector('#cash-coverage ' + post_class)
        self.assertIn('http://portal:8002/table/cflow_v2/?municipalities=BUF&year=2019&items=0430&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=2900&amountType=ADJB', element[1].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#cash-coverage ' + pre_class)
        self.assertIn('http://portal:8002/table/cflow/?municipalities=BUF&year=2019&items=4200&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=4600&amountType=ADJB', element[1].get_attribute("href"))

        # Spending of Operating Budget
        element = selenium.find_elements_by_css_selector('#operating-budget ' + post_class)
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=2900&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=2900&amountType=ADJB', element[1].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=2900&amountType=ADJB', element[2].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#operating-budget ' + pre_class)
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=4600&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=4600&amountType=ADJB', element[1].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=4600&amountType=ADJB', element[2].get_attribute("href"))
        ...
        self.assertIn('http://portal:8002/table/capital_v2/?municipalities=BUF&year=2019&items=4100&amountType=ADJB', element[1].get_attribute("href"))
        self.assertIn('http://portal:8002/table/capital_v2/?municipalities=BUF&year=2019&items=4100&amountType=ADJB', element[2].get_attribute("href"))
        ...
        self.assertIn('http://portal:8002/table/capital/?municipalities=BUF&year=2019&items=4100&amountType=ADJB', element[1].get_attribute("href"))
        self.assertIn('http://portal:8002/table/capital/?municipalities=BUF&year=2019&items=4100&amountType=ADJB', element[2].get_attribute("href"))
        ...
        self.assertIn('http://portal:8002/table/bsheet/?municipalities=BUF&year=2019&items=1401&amountType=AUDA', element[2].get_attribute("href"))

        # Fruitless and Wasteful Expenditure
        element = selenium.find_elements_by_css_selector('#wasteful-expenditure ' + post_class)
        self.assertIn('http://portal:8002/table/uifwexp/?municipalities=BUF&year=2019&items=irregular%2Cfruitless%2Cunauthorised', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=4600&amountType=AUDA', element[1].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#wasteful-expenditure ' + pre_class)
        self.assertIn('http://portal:8002/table/uifwexp/?municipalities=BUF&year=2019&items=irregular%2Cfruitless%2Cunauthorised', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=4600&amountType=AUDA', element[1].get_attribute("href"))

        # Current Ratio
        element = selenium.find_elements_by_css_selector('#current-ratio ' + post_class)
        self.assertIn('http://portal:8002/table/financial_position_v2/?municipalities=BUF&year=2019&items=0120%2C0130%2C0140%2C0150%2C0160%2C0170&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/financial_position_v2/?municipalities=BUF&year=2019&items=0330%2C0340%2C0350%2C0360%2C0370&amountType=AUDA', element[1].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#current-ratio ' + pre_class)
        self.assertIn('http://portal:8002/table/bsheet/?municipalities=BUF&year=2019&items=2150&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/bsheet/?municipalities=BUF&year=2019&items=1600&amountType=AUDA', element[1].get_attribute("href"))

        # Liquidity Ratio
        element = selenium.find_elements_by_css_selector('#liquidity-ratio ' + post_class)
        self.assertIn('http://portal:8002/table/financial_position_v2/?municipalities=BUF&year=2019&items=0120%2C0130&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/financial_position_v2/?municipalities=BUF&year=2019&items=0330%2C0340%2C0350%2C0360%2C0370&amountType=AUDA', element[1].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#liquidity-ratio ' + pre_class)
        self.assertIn('http://portal:8002/table/bsheet/?municipalities=BUF&year=2019&items=1800%2C2200&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/bsheet/?municipalities=BUF&year=2019&items=1600&amountType=AUDA', element[1].get_attribute("href"))

        # Current Debtors Collection Rate
        element = selenium.find_elements_by_css_selector('#collection-rate ' + post_class)
        self.assertIn('http://portal:8002/table/cflow_v2/?municipalities=BUF&year=2019&items=0120%2C0130%2C0280&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp_v2/?municipalities=BUF&year=2019&items=0200%2C0300%2C0400%2C0500%2C0600%2C0800%2C0900%2C1000&amountType=AUDA', element[1].get_attribute("href"))
        element = selenium.find_elements_by_css_selector('#collection-rate ' + pre_class)
        self.assertIn('http://portal:8002/table/cflow/?municipalities=BUF&year=2019&items=3010%2C3030%2C3040%2C3050%2C3060%2C3070%2C3100&amountType=AUDA', element[0].get_attribute("href"))
        self.assertIn('http://portal:8002/table/incexp/?municipalities=BUF&year=2019&items=0200%2C0400%2C1000&amountType=AUDA', element[1].get_attribute("href"))
