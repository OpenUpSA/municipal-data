...
class ScorecardTest(BaseSeleniumTestCase):
    ...
    def test_formulas(self):
        ...
        self.assertIn('( ( [Income & Expenditure] item code 4600, Audited Actual - [Income & Expenditure] item code 4600, Adjusted Budget ) / [Income & Expenditure] item code 4600, Adjusted Budget ) * 100', self.html_to_text(element))
        ...
        self.assertIn('( ( [Capital] item code 4100, Audited Actual - [Capital] item code 4100, Adjusted Budget ) / [Capital] item code 4100, Adjusted Budget ) * 100', self.html_to_text(element))
        ...
        self.assertIn('( [Capital] item code 4100, Audited Actual / ( [Balance Sheet] item code 1300, Audited Actual + [Balance Sheet] item code 1401, Audited Actual ) ) * 100', self.html_to_text(element))
        ...
        self.assertIn('[Balance Sheet] item code 2150, Audited Actual / [Balance Sheet] item code 1600, Audited Actual', self.html_to_text(element))
