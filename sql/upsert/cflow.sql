...
\copy cflow_upsert (demarcation_code, period_code, item_code, amount) FROM '/home/jdb/proj/code4sa/municipalmoney/data/Section 71 Q4 2016-17/cflow_2017q4_acrmun.csv' DELIMITER ',' CSV HEADER;
