...
\copy cflow_upsert (demarcation_code, period_code, item_code, amount) FROM '/home/jdb/proj/code4sa/municipalmoney/data/cflow_2017q4_acrmun.csv' DELIMITER ',' CSV HEADER;
