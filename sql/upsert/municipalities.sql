...
\copy municipality_contacts_upsert (demarcation_code,postal_address_1,postal_address_2,postal_address_3,street_address_1,street_address_2,street_address_3,street_address_4,phone_number,fax_number,url) FROM '/home/ubuntu/django-project/muni.csv' DELIMITER ',' CSV HEADER;
