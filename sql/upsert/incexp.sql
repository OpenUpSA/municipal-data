...
\copy incexp_upsert (demarcation_code, period_code, function_code, item_code, amount) FROM '/data/Section 71 Q3 2018-19/incexp_2019q3_acrmun.csv' DELIMITER ',' CSV HEADER;
