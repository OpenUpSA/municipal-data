...
\copy conditional_grants_upsert (demarcation_code, period_code, grant_code, amount) FROM '/home/ubuntu/data/Section 71 Q2 2017-18/grants_2018q2_acrmun.csv' DELIMITER ',' CSV HEADER;
