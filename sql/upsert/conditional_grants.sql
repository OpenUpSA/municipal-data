...
\copy conditional_grants_upsert (demarcation_code, period_code, grant_code, amount) FROM '/home/jdb/proj/code4sa/municipal_finance/datasets/2016q4/grants_2016q4_acrmun.csv' DELIMITER ',' CSV HEADER;
