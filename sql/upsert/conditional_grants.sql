...
\copy conditional_grants_upsert (demarcation_code, period_code, grant_code, amount) FROM '/data/Section 71 Q3 2018-19/grants_2019q3_acrmun.csv' DELIMITER ',' CSV HEADER;
