...
\copy conditional_grants_upsert (demarcation_code, period_code, grant_code, amount) FROM '/home/jdb/proj/code4sa/municipalmoney/data/Section 71 Q3 2017-18/grants_2018q3_acrmun.csv' DELIMITER ',' CSV HEADER;
