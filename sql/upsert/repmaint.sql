...
\copy repmaint_upsert (demarcation_code, period_code, item_code, amount) FROM '/home/jdb/proj/code4sa/municipalmoney/data/Section 71 Q3 2017-18/rm_2018q3_acrmun.csv' DELIMITER ',' CSV HEADER;
