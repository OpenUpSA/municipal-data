...
\copy audit_opinions_upsert (demarcation_code, financial_year, opinion_code, opinion_label) FROM '/home/ubuntu/django-project/audit_opinions.csv' DELIMITER ',' CSV HEADER;
