...
\copy municipality_staff_contacts_upsert (demarcation_code, role, title, name, office_number, fax_number, email_address) FROM '/home/jdb/proj/code4sa/municipal_finance/django-app/persons.csv' DELIMITER ',' CSV HEADER;
