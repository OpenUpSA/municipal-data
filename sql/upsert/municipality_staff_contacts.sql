...
\copy municipality_staff_contacts_upsert (demarcation_code, role, title, name, office_number, fax_number, email_address) FROM '/home/jdb/proj/code4sa/municipal_finance/django-app/muni_staff_contacts.csv' DELIMITER ',' CSV HEADER;
