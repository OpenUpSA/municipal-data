...
\copy municipality_staff_contacts_upsert (demarcation_code, role, title, name, office_number, fax_number, email_address) FROM '/home/jdb/projects/municipal-money/municipal-data/person.csv' DELIMITER ',' CSV HEADER;
