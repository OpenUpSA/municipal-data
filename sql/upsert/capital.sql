...
\copy capital_upsert (demarcation_code, period_code, function_code, item_code, new_assets, renewal_of_existing, total_assets, repairs_maintenance, asset_register_summary) FROM '/home/jdb/proj/code4sa/municipalmoney/data/Section 71 Q4 2016-17/capital_2017q4_acrmun.csv' DELIMITER ',' CSV HEADER;
