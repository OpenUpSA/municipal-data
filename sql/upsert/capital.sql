...
\copy capital_upsert (demarcation_code, period_code, function_code, item_code, new_assets, renewal_of_existing, total_assets, repairs_maintenance, asset_register_summary) FROM '/home/ubuntu/data/Section 71 Q2 2017-18/capital_2018q2_acrmun.csv' DELIMITER ',' CSV HEADER;
