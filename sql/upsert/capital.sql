...
\copy capital_upsert (demarcation_code, period_code, function_code, item_code, new_assets, renewal_of_existing, total_assets, repairs_maintenance, asset_register_summary) FROM '/home/jdb/proj/code4sa/municipal_finance/datasets/2017q3-not-audited/capital_2017q3_acrmun.csv' DELIMITER ',' CSV HEADER;
