...
\copy uifw_upsert (demarcation_code, financial_year, item_code, item_label, amount) FROM '/home/jdb/proj/code4sa/municipalmoney/django-project/uifw-2015.csv' DELIMITER ',' CSV HEADER;
