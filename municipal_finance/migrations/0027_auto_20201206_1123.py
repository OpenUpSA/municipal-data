# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2020-12-06 09:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('municipal_finance', '0026_initial_conditional_grant_types'),
    ]
    ...
    operations = [
        ...
        migrations.RenameModel(
            old_name='RepmaintFacts',
            new_name='RepairsMaintenanceFactsV1',
        ),
        migrations.RenameModel(
            old_name='RepmaintItems',
            new_name='RepairsMaintenanceItemsV1',
        ),
        migrations.AlterModelTable(
            name='repairsmaintenancefactsv1',
            table='repairs_maintenance_facts',
        ),
        migrations.AlterModelTable(
            name='repairsmaintenanceitemsv1',
            table='repairs_maintenance_items',
        ),
        migrations.AddField(
            model_name='repairsmaintenancefactsv2',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='municipal_finance.RepairsMaintenanceItemsV2'),
        ),
