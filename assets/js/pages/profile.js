import {
  logIfUnequal, locale, capFirst, formatFinancialYear, ratingColor, errorBoundary,
} from '../utils.js';
...
export default class ProfilePage {
  ...
  initHouseholdBills(pageData) {
    const { yearly_percent } = pageData;
    const chartData = pageData.household_chart_overall;
    const middleChartData = pageData.household_chart_middle;
    const affordableChartData = pageData.household_chart_affordable;
    const indigentChartData = pageData.household_chart_indigent;
