...
function temporary_webflow_fixes($) {
  ...
  //<div class="subsection-chart_wrapper">
  //$(".text_subsection-detail")
  var chartWrapper = "{% if quarter_data %}" + $(".subsection-chart_wrapper") + "{% else %}<h3 class='project-detail_heading'>No Data Available</h3>{% endif %}";
